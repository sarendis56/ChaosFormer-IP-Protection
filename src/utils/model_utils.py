...
from .vision_backbone_utils import get_transformer_layers
        ...
        if local_model_path and Path(local_model_path).exists():
            ...
            if not local_model_path:
                ...
                if default_local_path.exists() and default_local_path.is_dir():
                    ...
                    model = AutoModelForImageClassification.from_pretrained(str(default_local_path))
                    processor = AutoImageProcessor.from_pretrained(str(default_local_path), use_fast=True)
                else:
...
def load_encrypted_model(model_dir: Path,
    ...
    processor = AutoImageProcessor.from_pretrained(processor_path, use_fast=True)
